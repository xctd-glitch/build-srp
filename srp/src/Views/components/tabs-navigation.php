        ...
        <nav class="flex space-x-4" aria-label="Tabs">
            ...
            <button
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="hidden md:inline">Routing Config</span>
                </div>
            </button>
            ...
            <button
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="hidden md:inline">Environment</span>
                </div>
            </button>
            ...
            <button
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="hidden md:inline">Postback</span>
                </div>
            </button>
            ...
            <button
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="hidden md:inline">Traffic Logs</span>
                    <span class="hidden md:inline ml-1 rounded-full bg-muted px-1.5 py-0.5 text-[9px] font-medium"
